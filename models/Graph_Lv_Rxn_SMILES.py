...
class Graph_lv_rxn_Transformer_Base():
    def __init__(
            self,
            f_vocab: int,
            f_atom: int,
        ...
        self.model = Graph_lv_rxn_Transformer_Builder(
            f_vocab=f_vocab,
            f_atom=f_atom,
            f_bond=f_bond,
            token_idx=token_idx,
...
class Graph_lv_rxn_Transformer_Builder(nn.Module):
    def __init__(
            self,
            f_vocab: int,
            f_atom: int,
        ...
        super(Graph_lv_rxn_Transformer_Builder, self).__init__()
